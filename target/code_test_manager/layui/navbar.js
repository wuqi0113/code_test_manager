    ...
    function getHtml(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0) {
                ...
                for (var j = 0; j < data[i].children.length; j++) {
                    ...
                    if (data[i].children[j].children !== undefined && data[i].children[j].children !== null && data[i].children[j].children.length > 0) {
                        ...
                        for (var k = 0; k < grandsonNodes.length; k++) {
                            ulHtml += '<dd>';
                            ulHtml += '<a data-type="tabAdd" data-title="'+ grandsonNodes[k].title +'" data-id="'+grandsonNodes[k].menuId+'" data-url="'+ grandsonNodes[k].href +'" href="'+ grandsonNodes[k].href +'">' + grandsonNodes[k].title + '</a>';
                            ulHtml += '</dd>';
                        }
                        ulHtml += '</dl>';
                        ulHtml += '</dd>';
                        ...
                        ulHtml += '<dd>';
                        ulHtml += '<a data-type="tabAdd" data-title="'+data[i].children[j].title+'"  data-id="'+data[i].children[j].menuId+'" data-url="'+data[i].children[j].href+'" href="'+data[i].children[j].href+'">' + data[i].children[j].title;
                        ulHtml += '</a>';
                        ulHtml += '</dd>';
                    }
                ...
                ulHtml += '<a data-type="tabAdd" data-title="'+data[i].title+'"  data-id="'+data[i].menuId+'" href="' + data[i].href + '"' + dataUrl + '>';
