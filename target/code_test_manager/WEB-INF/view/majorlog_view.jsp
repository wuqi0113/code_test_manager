			 ...
			 <div class="layui-form layui-form-pane1 " action="" lay-filter="first">
			  <!-- 表格 -->
			    <div class="layui-form-item">
			        <table class="layui-hide" id="LAY_table_major" lay-filter="test"></table>
					<script type="text/html" id="barDemo">
						<%--<a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="view">编辑</a>--%>
					</script>
			    </div>
			 </div>
		</div>
...
<script src="<%=path%>/public/js/layui-majorlog.js"></script>
