                   ...
                   <div class="layui-form-item" id="code">
                    ...
                    <div class="layui-form-item">
                        ...
                        <input type="hidden" id="proAddress" name="proAddress" value="${proAddress}">
                            ...
                            <input type="text" id="proAddress" name="proAddress" value="${proAddress}">--%>
                    ...
                    <!-- 表格 -->
                    <div class="layui-form-item">
                        <table class="layui-hide" id="LAY_pro_child" lay-filter="proDemo"></table>
...
<script src="<%=path%>/public/js/layui-pro-child.js" defer></script>
