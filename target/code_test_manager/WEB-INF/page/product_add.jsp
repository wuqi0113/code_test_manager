...
<body class="childrenBody">
                ...
                <form class="layui-form layui-form-pane1 re-formp" id="arf" onsubmit="check()" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux">
                            <input type="text" name="proName" id="proName"lay-verify="required|proName" required placeholder="" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <c:if test="${sname!=null}">
                            ...
                            <div class="layui-form-mid layui-word-aux">
                                <input type="text" name="sname" id="sname" value="${sname}"readonly lay-verify="required|sname" required placeholder="" autocomplete="off" class="layui-input">
                            </div>
                            <%--<label class="layui-form-label">批次编号：</label>
                            <div class="layui-form-mid layui-word-aux">
                                <input type="text" name="batch" id="batch" value="" lay-verify="required|sname" required placeholder="" autocomplete="off" class="layui-input">
                            </div>--%>
                        </c:if>
                        <c:if test="${sname==null}">
                            <label class="layui-form-label">英文名称：</label>
                            <div class="layui-form-mid layui-word-aux">
                                <input type="text" name="sname"  value="" lay-verify="required|sname" required placeholder="" autocomplete="off" class="layui-input">
                            </div>
                        </c:if>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="proDescribe" id="proDescribe" placeholder="" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <textarea id="proDisplay" name="proDisplay" style="width:100%;height:260px;" data-options=""><span id="aaa"></span></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
                        <label class="layui-form-label">生产许可证：</label>
                        <div class="layui-input-block">
                            <input type="text" id="productLicense" name="productLicense"placeholder="SC10622030200432" class="layui-input"/>
                        </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
                        <label class="layui-form-label">产品规格：</label>
                        <div class="layui-input-block">
                            <input type="text" id="productSize" name="productSize"placeholder="445ml*10" class="layui-input"/>
                        </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
                        <label class="layui-form-label">保质期：</label>
                        <div class="layui-input-block">
                            <input type="text" id="qualityPeriod" name="qualityPeriod"placeholder="12个月" class="layui-input"/>
                        </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            ...
                            <input type="number"  name="reward" id="reward"  onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');" lay-verify="" placeholder="" autocomplete="off" class="layui-input">
                        </div>
...
<script src="<%=path%>/public/page-js/layui-product-add.js"></script>
