                ...
                <form class="layui-form layui-form-pane1 re-formp" id="arf" onsubmit="check()" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="proDescribe" id="proDescribe"value="${data.proDescribe}" placeholder="" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <input type="text" id="productLicense" name="productLicense"placeholder="SC10622030200432" value="${data.productLicense}" class="layui-input"/>
                        </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
