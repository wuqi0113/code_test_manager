		...
		<div class="re-form">
			 ...
			 <div class="layui-form layui-form-pane1 " action="" lay-filter="first">
			 	<div class="layui-form-item">
					<a class="layui-btn layui-btn-normal newsAdd_btn">添加资讯</a>
					<%--<a class="layui-btn layui-btn-normal pageAdd_btn">设置主页</a>--%>
			 ...
			 <%-- <fieldset class="layui-elem-field re-padding-arround re-panel-width re-center">
			  	<p>企业剩余token总数</p>
			  	<p id="test" &lt;%&ndash;style="opacity: 0"&ndash;%&gt;>${balance}</p>
...
<script src="<%=path%>/public/page-js/layui-news-table.js"></script>
