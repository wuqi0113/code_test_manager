...
<div class="layui-layout">
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <div>
                <h2 class="re-title">添加溯源信息 </h2>
                <div style="height: 1px;background-color: black;"></div>
            </div>
            <div class="re-form">
                <h5>溯源信息</h5>

                <form class="layui-form layui-form-pane1 re-formp" action="<%=path%>/productTraceability/save" lay-filter="first" enctype="multipart/form-data">
