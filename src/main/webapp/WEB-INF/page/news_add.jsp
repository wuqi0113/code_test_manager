  ...
  <div class="layui-body">
    ...
    <div style="padding: 15px;">
		...
		<div class="re-form">
			 ...
			 <form class="layui-form layui-form-pane1 re-formp" action="<%=path%>/news/saveNews" lay-filter="first" method="post">
			 ...
			 <div class="layui-form-item">
				 <label class="layui-form-label">是否推送到钱包</label>
				 <div class="layui-input-block">
			...
			<div class="layui-form-item re-center">
			    <button class="layui-btn layui-btn-primary" lay-submit="" lay-filter="">保存</button>
...
<script src="<%=path%>/public/js/layui-use-table-comunity2.js"></script>
