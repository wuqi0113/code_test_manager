            ...
            <div class="re-form">
                ...
                <div class="layui-form layui-form-pane1 " action="" lay-filter="first">
                    <div class="layui-form-item" id="code">
                        ...
                        <button class="layui-btn layui-btn-radius layui-btn-primary" data-type="medala">生成防伪信息</button>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <fieldset class="layui-elem-field re-padding-arround">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-form-mid layui-word-aux">${data.proName}</div>
                            </div>
                            <div class="layui-inline">
                                <label class="layui-form-label">产品地址：</label>
                                <div class="layui-form-mid layui-word-aux">${data.proAddress}</div>
                            </div>
                            <div class="layui-inline">
                                <label class="layui-form-label">英文名称：</label>
                                <div class="layui-form-mid layui-word-aux">${data.sname}</div>
                            </div>
                        </fieldset>
                    </div>
                   ...
                   <%-- <div class="layui-form-item">
                    ...
                    <!-- 表格 -->
                    <div class="layui-form-item">
                        <table class="layui-hide" id="LAY_table_code" lay-filter="LAY_table_code"></table>
...
<script src="<%=path%>/public/page-js/layui-product-create-code.js" defer></script>
