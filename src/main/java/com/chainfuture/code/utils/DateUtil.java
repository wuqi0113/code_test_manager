...
public class DateUtil {
     ...
     * @return
     */
    public static String getNextYear(Date date,Integer  num) {
        Calendar calendar = Calendar.getInstance();
//        Date date = new Date(System.currentTimeMillis());
        calendar.setTime(date);
        calendar.add(Calendar.YEAR, num);
        date = calendar.getTime();
        return DateUtil.getStringDate(date, DateUtil.DateFormat1);
    }
     ...
     * @return
     */
    public static String getNextMonth(Date date,Integer  num) {
        Calendar calendar = Calendar.getInstance();
//        Date date = new Date(System.currentTimeMillis());
        calendar.setTime(date);
     ...
     * @return
     */
    public static String getNextMonth2(Date date,Integer  num) {
        Calendar calendar = Calendar.getInstance();
//        Date date = new Date(System.currentTimeMillis());
        calendar.setTime(date);
        calendar.add(Calendar.MONTH, num);
